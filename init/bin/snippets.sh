...
init/bin/rapi.sh POST https://es01:9200/spark-active-index/_update_by_query init/q2.json | jq . > r.json
...
init/bin/rapi.sh PUT _watcher/watch/spark_batch_watcher init/batch_info.spark.watcher.json  | jq .
init/bin/rapi.sh POST spark-active-index/_update_by_query init/clear_copied_flag.json | jq . > r.watch.json
