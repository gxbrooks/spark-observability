...
rapi PUT /_ilm/policy/batch-active init/batch-active/batch-active.ilm.json
rapi PUT /_index_template/batch-active-index init/batch-active/batch-active-index.template.json
rapi PUT /batch-active-index-000001 init/batch-active/batch-active-index.index.json


rapi PUT /_ilm/policy/spark-logs init/spark/spark-logs.ilm.json
rapi PUT /_index_template/logs-spark-spark init/spark/logs-spark-spark.template.json

rapi PUT /_ilm/policy/data-pipeline init/data-pipeline/data-pipeline.ilm.json
rapi PUT /_index_template/data-pipeline-ds init/data-pipeline/data-pipeline-ds.template.json
