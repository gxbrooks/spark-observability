...
|spark-worker-lab1
|Spark worker on Lab1
|servicenow.io/application-service-identifier=spark-worker-lab1

|spark-worker-lab2
|Spark worker on Lab2
|servicenow.io/application-service-identifier=spark-worker-lab2
|===
...
application_services:
  ...
  - name: Spark Worker (Lab1)
    ...
    short_description: Spark worker on Lab1
    platform: kubernetes
    service_mapping: tags
    discover: false
    namespace: spark
