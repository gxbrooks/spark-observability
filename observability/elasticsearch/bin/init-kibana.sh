...
# Add current directory to PATH for kapi script
...
echo "Testing Kibana status endpoint..."
kapi GET /api/status > /tmp/kibana-status.json 2>&1 || {
  echo "❌ Failed to connect to Kibana API"
  exit 1
}
echo "✅ Kibana API is accessible"
echo ""

echo "=== STARTING DATA VIEW CREATION ==="
...
echo "✅ Spark logs data view created"
...
echo "✅ Watcher data view created"
...
echo "✅ Batch events data view created"
...
echo "✅ Batch metrics data view created"
...
echo "✅ Batch traces data view created"
...
echo "✅ Spark GC data view created"
...
echo "✅ OTel traces data view created"

echo ""
echo "=== DATA VIEW CREATION COMPLETE ==="
echo "All data views have been successfully created and configured."
echo "Note: elastic_api.py validates all HTTP responses - any failures would have caused script to exit"
