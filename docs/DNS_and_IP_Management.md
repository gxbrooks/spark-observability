...
Router DHCP Settings:
  ...
  MAC: <Lab3-MAC>       → IP: 192.168.1.49  (Lab3 — observability Docker, K8s control plane, NFS, HDFS, Jupyter; see architecture-and-resources.md)
```
...
| 1.2 | 2026-03-27 | Host role comments aligned with target topology (Lab3 control+NFS+HDFS; Lab1/Lab2 workers); see architecture-and-resources.md |
