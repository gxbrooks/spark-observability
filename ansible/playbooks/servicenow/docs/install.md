...
- `../../../servicenow/docs/Tag_Based_Service_Mapping.md` — tag-based Service Mapping UI and `cmdb_key_value`
- `../../../servicenow/docs/CSDM_Specifications.md` — CSDM YAML schema and deploy processor rules
- `../README.md` — playbook layout
- `../discovery/docker/README.md` — Docker container sync and label upsert
- `../discovery/k8s/sync_pod_labels.yml` — Kubernetes `servicenow.io/*` pod label sync
- `../discovery/host/sync_tags.yml` — Host agent `servicenow.io/*` on linux_server CIs
